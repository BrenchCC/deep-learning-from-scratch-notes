...
title: "Chapter 2.5 PyTorch 中的 nn.Module：组织模型、参数与状态"
order: 5
---
...
如果所有东西都只是散落在外面的张量，这些问题都要手动管理。nn.Module 的作用，就是把这些职责收拢到一个对象里。它不仅是一个可以前向计算的对象，也是 PyTorch 用来组织**计算、参数、缓冲区和子模块**的基本容器。
